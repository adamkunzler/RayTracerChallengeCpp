...
namespace RayTracer
{
	...
	void Sphere::localIntersectBy(const Ray& localRay, std::vector<std::shared_ptr<Intersection>>& intersections) const
	{
		...
		intersections.push_back(std::shared_ptr<Intersection>(new Intersection(t2, (IShape*)this)));
	}
